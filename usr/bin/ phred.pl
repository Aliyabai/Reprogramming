...
# if phred is +33 (sanger), run soapnuke with -Q 2 and run tophat with --solexa-quals 
# if phred is +64 (Hiseq 2000/4000), run soapnuke with -Q 1 and run tophat wiht --solexa1.3-quals
use strict;

# Copyright (c) 2013 jiewencai<at>qq.com
#Usage:  perl fastq_phred_decide.pl fastq_file_name [reads number,default 1000]
